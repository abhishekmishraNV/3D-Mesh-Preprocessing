...
Project by: Abhishek Mishra
Email id : am7197@srmist.edu.in
Course: 3D Mesh Preprocessing & Quantization Pipeline
Tools: Python, NumPy, Matplotlib, Jupyter Notebook, VS Code
Sample Data: Stored in 8samples/

This project is submitted as part of the Mixar/Virtual Assignment. It reflects my own work on 3D mesh normalization, quantization, and analysis for the course requirements.
